...
function PandaMascot() {
  return (
    <svg viewBox="0 0 80 80" width="72" height="72" aria-hidden="true">
      ...
      <circle cx="31" cy="41" r="3.2" fill="var(--ink-on-light)" opacity="0.85" />
      <circle cx="49" cy="41" r="3.2" fill="var(--ink-on-light)" opacity="0.85" />
      <path
  ...
  return (
    ...
    >
      <div style={{ display: "flex", flexDirection: "column", gap: 10, minWidth: 0 }}>
        ...
        <h2 style={{ color: "#fff", fontSize: 21.6, fontWeight: 800, margin: 0 }}>今日の学習</h2>

        <p style={{ color: "#fff", fontSize: 15.6, opacity: 0.85, margin: 0 }}>
          AIがあなたに合った問題を用意しました
        </p>

        <GlassButton variant="white" size="sm" onClick={() => router.push("/quiz/ai")}>
          <span style={{ color: "var(--ink-on-light)", display: "inline-flex", alignItems: "center", gap: 6 }}>
            <StarIcon />
            はじめる
          </span>
        </GlassButton>
